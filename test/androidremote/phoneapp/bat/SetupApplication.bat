...
:: Android packaging
set AND_CERT_NAME="PhoneTouch"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\PhoneTouch.p12
...
set IOS_PROVISION=cert\PhoneTouch.mobileprovision
...
set APP_ID=air.turbosqel.remote.PhoneTouch

:: Output packages
set DIST_PATH=dist
set DIST_NAME=PhoneTouch
